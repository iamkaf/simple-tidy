...
Simple Sort adds a compact sorting button to normal Minecraft storage screens.
...
Simple Sort requires [Amber](https://modrinth.com/mod/amber).
...
loader metadata, which may break addons and mixins that target Simple Sort
